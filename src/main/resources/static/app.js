...
async function loadUsers() {
    try {
        ...
        // For now, we'll populate with sample users
...
async function loadTasks() {
    try {
        ...
        if (response.ok) {
            ...
            taskList.innerHTML = '<p class="error-message show">Failed to load tasks</p>';
        }
    } catch (error) {
        console.error('Error loading tasks:', error);
        taskList.innerHTML = '<p class="error-message show">Error loading tasks</p>';
    }
}
...
function filterAndDisplayTasks() {
    ...
    if (sortValue === 'date') {
        filteredTasks.sort((a, b) => {
            const dateA = a.scheduledDateTime ? new Date(a.scheduledDateTime) : new Date(a.createdDate);
            const dateB = b.scheduledDateTime ? new Date(b.scheduledDateTime) : new Date(b.createdDate);
            return dateA - dateB;
        });
    ...
    return `
        <div class="task-item">
            ...
            <div class="task-details">
                ...
                ${task.assignedUserId ? `<span>👤 Assigned to User #${task.assignedUserId}</span>` : '<span>👤 Unassigned</span>'}
            </div>
            ${showActions ? `
